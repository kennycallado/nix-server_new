let
  ...
  server-01 = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPSU/RF++FftGyfoGeq5JcXd9XfcVZgW6SOKo2OEXB6Q";
  agent-01 = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEarQwbQb19k4Bp7iK9oOxM/ePvCq3LSwN20myktfNNR";
  agent-02 = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHhbxg/YxtWjhid5XxbuI0xsnNGHcKZGo8zqg6SGyTJG";

  allKeys = [ admin server-01 agent-01 agent-02 ];
in
{
  ...
  "wireguard-server-01.age".publicKeys = [ admin server-01 ];
  "wireguard-agent-01.age".publicKeys = [ admin agent-01 ];
  "wireguard-agent-02.age".publicKeys = [ admin agent-02 ];
